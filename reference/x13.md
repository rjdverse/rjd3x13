...
#>  QS test on SA: Good (0.050);  F-test on SA: Good (0.898)
#> 
...
#>  QS test on SA: Bad (0.003);  F-test on SA: Good (0.809)
#> 
#> For a more detailed output, use the 'summary()' function.
regarima_fast(y, "rg0")
...
#> 
#>  Seasonal filter: FILTER_S3X3;  Trend filter: H-23 terms
#>  M-Statistics: q Good (0.552); q-m2 Good (0.624)
#>  QS test on SA: Good (0.210);  F-test on SA: Good (0.994)
#> 
#> For a more detailed output, use the 'summary()' function.
sp <- set_x11(sp,
    henderson.filter = 13
...
#>  QS test on SA: Good (0.189);  F-test on SA: Good (0.990)
#> 
#> For a more detailed output, use the 'summary()' function.
j <- jx13(y, spec = sp)
class(j)
